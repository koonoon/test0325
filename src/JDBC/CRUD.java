...
public class CRUD {
	...
	public void insert1()  {
		...
		public void insert() {
			...
			String sql = "INSERT INTO NAVER VALUES('아이디3','1111', '이름', 29, '남자', 'cktogks@gmail.com', '01012345687')";
		...
		public void update() {
			...
			try {	// 문제가 없으면 try문 실행, catch문 실행 x
				...
				String sql = "UPDATE NAVER SET NAGE=25 WHERE NID='아이디'";
		...
		public void delete() {
			...
			// [1] 준비단계 : con(먼저 선언), stmt(나중) => try, catch문
			// [2] 작성단계 : sql
			// [3] 실행단계 : execute
			...
			try {
				...
				String sql = "DELETE FROM NAVER WHERE NID = 'Kooky'";
